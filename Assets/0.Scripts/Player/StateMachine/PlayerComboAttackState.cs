...
public class PlayerComboAttackState : PlayerAttackState
{
    ...
    public override void Update()
    {
        ...
        if (normalizedTime < 1f)
        {
            ...
            // Weapon 켜준다
            stateMachine.Player.Weapon.SetAttack(stateMachine.Player.Data.AttakData.GetAttackInfo(stateMachine.ComboIndex).Damage, 
                stateMachine.Player.Data.AttakData.GetAttackInfo(stateMachine.ComboIndex).Force);
